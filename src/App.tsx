...
const Signup = withLogging(lazy(() => import("./pages/Signup")));
const Dashboard = withLogging(lazy(() => import("./pages/Dashboard")));
const UserProgression = withLogging(lazy(() => import("./pages/UserProgression")));
const CertificationPage = withLogging(lazy(() => import("./pages/CertificationPage")));
