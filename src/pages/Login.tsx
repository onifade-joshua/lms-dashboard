      ...
      <div className="hidden md:flex md:w-1/2 relative overflow-hidden flex-col justify-center items-center">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full text-white p-12">
          <h1 className="text-4xl font-bold flex items-center mb-4">
            <Logo />
            <span className="ml-2">Lms Dashboard</span>
          </h1>
          <p className="text-xl mb-8 text-start max-w-md">
            Your personal LMS online dashboard app to track, analyze,
            manage, and grow your career.
          </p>
          <div className="space-y-4 max-w-md font-bold">
            <div className="flex items-start">
              ...
              <p>Track your learning progress in real-time across Web, Cloud, and AI/ML domains</p>
            </div>
            <div className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 text-blue-300 mr-3">
                <svg
              ...
              <p>Set personalized learning goals and achieve career milestones with confidence</p>
            </div>
            <div className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 text-blue-300 mr-3">
                <svg
              ...
              <p>Monitor your skill development and certification readiness with intelligent analytics</p>
            </div>
          </div>
        </div>
      </div>
