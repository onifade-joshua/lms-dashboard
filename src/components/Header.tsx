...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  // LMS-specific mock notifications
  const notifications = [
    {
      id: 1,
      type: "alert",
      message: "New course 'Advanced React' has been added to your schedule.",
      time: "5 minutes ago",
      read: false,
    },
    {
      id: 2,
      type: "transaction",
      message: "You received a grade of A+ on 'Introduction to Programming'!",
      time: "2 hours ago",
      read: false,
    },
    {
      id: 3,
      type: "system",
      message: "Your next exam is scheduled for tomorrow at 10 AM.",
      time: "3 hours ago",
      read: true,
    },
    {
      id: 4,
      type: "goal",
      message: "You’re 75% through your course 'Web Development Basics'!",
      time: "1 day ago",
      read: true,
    },
  ];
